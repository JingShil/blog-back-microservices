...
//    private final static String ARTICLE_UPDATE_QUEUE = "article.update.queue";
...
//    private final static String ARTICLE_UPDATE_KEY = "article.update";
